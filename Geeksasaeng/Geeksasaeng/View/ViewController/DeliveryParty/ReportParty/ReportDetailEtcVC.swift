...
class ReportDetailEtcViewController: UIViewController {
    ...
    lazy var reportFailView = UIView().then {
        ...
        /* set lineView */
        lineView.snp.makeConstraints { make in
            make.top.equalTo(failContentLabel.snp.bottom).offset(screenHeight / 53.33)
    ...
    override func viewDidLoad() {
        ...
        print("DEBUG: 기타 사유 신고 화면 데이터", reportCategoryId, partyId, memberId)
    }
    ...
    private func setLayouts() {
        ...
        reportTextView.snp.makeConstraints { make in
            make.top.equalTo(reportCategoryLabel.snp.bottom).offset(screenWidth / 15.65)
